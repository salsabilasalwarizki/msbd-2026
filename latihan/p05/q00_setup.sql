-- Diminta: menyiapkan skema lab5 dengan enum, domain, dan tabel transaksi.
-- Dipilih: CREATE SCHEMA CASCADE untuk isolasi dari skema public.
-- Alternatif: pakai skema public; tidak dipilih karena bisa mengganggu data Pagila.
...
SELECT count(*) AS jumlah_inventory FROM public.inventory;
SELECT count(*) AS jumlah_staff FROM public.staff;